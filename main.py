...
def run_snake_game():
    ...
    try:
        ...
        print(f'Error loading the background music for the game: {e}')
...
def main_menu():
    ...
    while running_menu:
        ...
        pygame.draw.rect(screen, button_time, play_button_rect)
        screen.blit(play_text, play_text_rect)

        pygame.draw.rect(screen, button_reality, exit_button_rect)
